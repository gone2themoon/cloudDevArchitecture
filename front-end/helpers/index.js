(function (){
  ...
  // Returns the session ID, if no one is logged in.
  // This session ID is used only where a user is not logged.
  // It's probably a good method of allowing "Non-Logged-in" customers to create a cart and view items.
